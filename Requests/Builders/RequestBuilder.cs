...
namespace Pyrus.ApiClient.Requests.Builders
{
    public static class RequestBuilder
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="UpdateCatalogItemsRequestBuilder"/> class.
        /// </summary>
        /// <param name="catalogId">ID of a catalog.</param>
        /// <returns>Instance of <see cref="UpdateCatalogItemsRequestBuilder"/>.</returns>
        public static UpdateCatalogItemsRequestBuilder UpdateCatalogItems(int catalogId)
            => new UpdateCatalogItemsRequestBuilder(catalogId);
        ...
        public static async Task<TaskResponse> Process(this FormTaskBuilder builder, PyrusClient client)
            => await client.CreateTask(builder, null, builder.IdempotencyKey);

        public static async Task<TaskResponse> Process(this FormTaskBuilder.FormFieldsBuilder builder, PyrusClient client)
            => await client.CreateTask(builder, null, builder.BuildFields().IdempotencyKey);
        ...
        public static async Task<TaskResponse> Process(this SimpleTaskCommentBuilder builder, PyrusClient client)
            => await client.CommentTask(builder.TaskId, builder, null, builder.IdempotencyKey);
        ...
        public static async Task<TaskResponse> Process(this FormTaskCommentBuilder.FieldUpdatesBuilder builder, PyrusClient client)
            => await client.CommentTask(builder.TaskId, builder, null, builder.BuildFieldUpdates().IdempotencyKey);
        ...
        /// <summary>
        /// Executes a request prepared by <see cref="UpdateCatalogItemsRequestBuilder"/>.
        /// </summary>
        /// <param name="builder">An instance of <see cref="UpdateCatalogItemsRequestBuilder"/>.</param>
        ...
        public static Task<SyncCatalogResponse> Process(this UpdateCatalogItemsRequestBuilder builder, PyrusClient client)
        {
            if (builder is null)
            ...
            return client.UpdateCatalogItems(builder.CatalogId, builder);
        }
        ...
        public static async Task<RoleResponse> Process(this DeleteRoleRequestBuilder builder, PyrusClient client)
            => await client.DeleteRole(builder);
