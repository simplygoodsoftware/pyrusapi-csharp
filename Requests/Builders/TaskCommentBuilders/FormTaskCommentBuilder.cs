...
namespace PyrusApiClient.Builders
{
	public class FormTaskCommentBuilder : TaskCommentBuilderBase<FormTaskCommentBuilder>
	{
		...
		public FormTaskCommentBuilder SendToMobileApp()
		{
			Comment.Channel = new Channel
			{
				Type = ChannelType.MobileApp
			};
		...
		public FormTaskCommentBuilder WithDueDate(DateTime date)
		{
		...
		public FormTaskCommentBuilder WithDue(DateTime dateTime, int? duration = null)
		{
